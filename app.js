...
async function syncToBoard() {
  ...
  //
  // Einfachster, zuverlässigster Ansatz: direkte 'elbowed'-Connectors von der Karte
  // des Elternknotens (unten-mittig) zur Karte des Kindknotens (oben-mittig). Miro
  // routet diese automatisch im klassischen Baumdiagramm-Muster: erst gerade nach
  // unten, dann horizontal zur X-Position des Kindes, dann gerade nach unten zum Kind.
  // Keine zusätzlichen Hilfspunkte, Sammelschienen oder Branch-Punkte nötig.
      ...
      try {
        const connector = await miro.board.createConnector({
          ...
          start: {
            ...
            // Explizite Position statt snapTo: 'bottom', damit Miro den Startpunkt
            // nicht eigenständig verschieben kann (Anti-Overlap-Verhalten bei mehreren
            // Connectors vom selben Punkt). x:0.5 = horizontal mittig, y:1.0 = unterer Rand.
